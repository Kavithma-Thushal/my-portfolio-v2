        ...
        <nav className="bg-darkBlue text-white p-2 fixed w-full z-50">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden lg:flex space-x-10 mr-8 text-1xl font-semibold">
                    ...
                    <Link to="/skills" className="hover:text-neonBlue transition-colors duration-300">SKILLS</Link>
                    <Link to="/services" className="hover:text-neonBlue transition-colors duration-300">SERVICES</Link>
                    <Link to="/projects" className="hover:text-neonBlue transition-colors duration-300">PROJECTS</Link>
            ...
            <div className={`${isOpen ? "block" : "hidden"} md:hidden bg-darkBlue`}>
                <div className="flex flex-col items-center space-y-5 py-5">
                    ...
                    <Link to="/skills" onClick={toggleMenu}
                          className="hover:text-neonBlue transition-colors duration-300">SKILLS</Link>
                    <Link to="/services" onClick={toggleMenu}
                          className="hover:text-neonBlue transition-colors duration-300">SERVICES</Link>
                    <Link to="/projects" onClick={toggleMenu}
                          className="hover:text-neonBlue transition-colors duration-300">PROJECTS</Link>
